...
@app.route('/generate')
def gen():
    skill = requests.get('http://service2-skill:5000/get_skill')
    alliance = requests.get('http://service3-alliance:5000/get_alliance')
    race = requests.post('http://service4-race:5000/get_race',data=alliance.text)
